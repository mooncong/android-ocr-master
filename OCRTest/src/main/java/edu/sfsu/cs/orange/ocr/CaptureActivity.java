...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private ViewfinderView mViewFindViewSize;
...
//    progressView = (View) findViewById(R.id.indeterminate_progress_indicator_view);
        ...
        // 设置 选字的图框大小
        setViewFindViewSize(viewfinderView);
    ...
    void onShutterButtonPressContinuous() {
        ...
        if (lastResult != null) {
            ...
            Toast toast = Toast.makeText(this, getString(R.string.ocr_failed), Toast.LENGTH_SHORT);
...
//                shareTranslatedTextIntent.putExtra(android.content.Intent.EXTRA_TEXT, translationView.getText());
    ...
    public void setViewFindViewSize(ViewfinderView viewFindViewSize) {
